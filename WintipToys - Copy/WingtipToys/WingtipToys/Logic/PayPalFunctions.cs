...
public class NVPAPICaller
{
    ...
    public string APIUsername = "cbond00-facilitator_api1.g.uafs.edu";
    private string APIPassword = "1384232662";
    private string APISignature = "An5ns1Kso7MWUdW4ErQKJJJ4qi4-AEvl6nl99WdXh81frEpl-TSNBLKG";
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            QueensBookStore.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
